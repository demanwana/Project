...
- **Assignment Description:** This project is a simple web application that uses a Node.js and Express REST API to provide employee data. A basic front-end connects to the API and lets users search employees by name or age using a clean, styled interface.
